...
$hostname = 'http://localhost:1234/MetaCLADE_webserver'; #hostname is "wwww.lcqb.upmc.fr" in production phase, your host ip during development
$appurl   = $hostname; #In production ask the sysadmin for making this address avalaible from the external.
