...
$appsroot = '/var/www/html/MetaCLADE_webserver/'; #It is "/appsdata" on production whatever you want on development. Anyway, has to be accessible to apache
$approot  = '$appsroot/$appname';  #Directory where the app is hosted. It has to be accessible from apache user
$hostname = 'localhost:1234'; #hostname is "wwww.lcqb.upmc.fr" in production phase, your host ip during development
