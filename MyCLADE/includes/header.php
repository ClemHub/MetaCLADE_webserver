...
<head>
	...
	<link rel="stylesheet" type="text/css"  href="http://localhost/MetaCLADE_webserver/MyCLADE/css_style/style.css">
...
<div id='container'>
	<div id="header-menu">
		...
		<div class="topnav" id="myTopnav">
			...
			<a href="http://localhost/MetaCLADE_webserver/MyCLADE/home.php" class = 'active'>Home</a>
			<div class='dropdown'>
				<button class="dropbtn">Tools
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content">
					<a href="http://localhost/MetaCLADE_webserver/MyCLADE/small_annotation.php">Few domains annotation</a>
					<!-- <a href="http://localhost:8888/MetaCLADE_webserver/MyCLADE/small_annotation.php">Few domains annotation</a> -->
					<a href="http://localhost/MetaCLADE_webserver/MyCLADE/large_annotation.php">All domains annotation</a>
			...
			<div class='dropdown'>
				...
				<div class="dropdown-content">
					...
					<a href="http://localhost/MetaCLADE_webserver/MyCLADE/help.php#input">Input</a>
					<!-- <a href="http://localhost:8888/MetaCLADE_webserver/MyCLADE/help.php#output">Output</a> -->
					<a href="http://localhost/MetaCLADE_webserver/MyCLADE/help.php#output">Output</a>
					<!-- <a href="http://localhost:8888/MetaCLADE_webserver/MyCLADE/help.php#method">Method</a> -->
					<a href="http://localhost/MetaCLADE_webserver/MyCLADE/help.php#method">Method</a>
				</div>
			</div>
			<!-- <a href="http://localhost:8888/MetaCLADE_webserver/MyCLADE/references.php">References</a> -->
			<a href="http://localhost/MetaCLADE_webserver/MyCLADE/references.php">References</a>
			<!-- <a href="http://localhost:8888/MetaCLADE_webserver/MyCLADE/contact.php">Contact</a> -->
			<a href="http://localhost/MetaCLADE_webserver/MyCLADE/contact.php">Contact</a>
