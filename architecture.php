...
<?php include("./includes/menu.php"); ?>
	...
	while(!feof($file_content)){
		...
		if($exploded_line[0]==$seq_id){{
			...
			echo "<span class='tooltip'><g><a xlink:href='http://pfam.xfam.org/family/".$pfam."' target='_blank'><rect x='".$scaled_start."%' y='5' width='". $width ."%' height='30' style=' fill:".$color."; fill-opacity:0.7; stroke-width:1; stroke:3'>";
			...
			echo "<text x='". $scaled_start ."%' y='25' style='font-size:15px; font-size-adjust: 0.5; fill:white; font-weight:bold; mix-blend-mode: exclusion;' >".$pfam."</text></a></g></span>";
