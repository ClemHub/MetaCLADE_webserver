<?php include("./includes/header.php"); ?>
	...
	<section class = 'tools'>
		...
		<form autocomplete="off" name="clan_annotation_form" method = POST action="submit.php?form=clan" enctype="multipart/form-data" onsubmit="return clan_form_submission(clan)">
