<?php include('./includes/header.php'); ?>
  <section id ='example'>
    ...
    <p>Protein function for a combination of domains in a sequence is not easily deducible based on the function of single domains. Yet, the use of known domain combinations and GO_terms for single domains can help the user for a fast eploration of potential protein functions with MyCLADE. </p>
