<?php include('./includes/header.php'); ?>
	...
	<p align="center"><img <?php echo "src='".$appurl."/server_images/help_images/Screen Shot 2021-04-12 at 16.35.08.png'"?>; width="1000" height="500"></p>
	...
	<p>By hovering over a domain ID, a synthesis of the annotation for that domain hit is reported in a toolpit. By clicking the domain ID, one access the Pfam website for that domain. </p>
	...
	<blockquote>
	  <p align="center"><img <?php echo "src='".$appurl."/server_images/help_images/Screen Shot 2021-04-09 at 08.55.37.png'";?> width="1013" height="115" border="1"></p>
	  </blockquote>
	...
	<p align="left">Logos are svg files and can be imported for insertion in articles.</p>
	...
	<p align="center"><img <?php echo "src='".$appurl."/server_images/help_images/time.png'";?> width="554" height="486"></p>
	...
	<p>MyCLADE performance has been evaluated <strong>without DAMA</strong> because DAMA computing time is negligeable (for a few hundred proteins, the architecture reconstruction takes less than a few seconds) as described in Table 2 of (<a href="https://academic.oup.com/bioinformatics/article/32/3/345/1743675?login=true">Bernardes et al.  <em>Bioinformatics</em>, 32:345–353, 2016</a>):</p>
	<p align="center"><img <?php echo "src='".$appurl."/server_images/help_images/Table time DAMA.png'";?> width="586" height="211"></p>
	<h3 align="left"><br>
