		...
		*/
		...
		if ($data){
			...
			foreach($data as $line){
				...
				settype($s_line[1], 'int');
				settype($s_line[2], 'int');
				settype($s_line[3], 'int');

				settype($s_line[6], 'int');
				settype($s_line[7], 'int');
				settype($s_line[8], 'int');

				settype($s_line[9], 'float');
				settype($s_line[10], 'float');
				settype($s_line[11], 'float');
				echo "<tr>";
				$i = 0;
