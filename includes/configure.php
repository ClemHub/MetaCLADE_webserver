...
$appurl   = $hostname.'/myclade'; #In production ask the sysadmin for making this address avalaible from the external.
$webdevel = 'clemenceblachon@gmail.com'; #mail address of the webdevelopment
?>
