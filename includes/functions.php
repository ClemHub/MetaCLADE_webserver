...
function submit($job_id, $email){
	...
	if ($form == 'small'){
		...
		$command="qsub -pe smp 1 -wd ".$approot."/jobs/".$job_id."/ -N $job_id -b y /home/blachon/Documents/Tools/metaclade2/metaclade2/metaclade2 ".$args;}
	else if($form == 'large'){
		$args = $args." -t ".escapeshellarg(6);
		$command="qsub -pe smp 2 -wd ".$approot."/jobs/".$job_id."/ -N $job_id -b y /home/blachon/Documents/Tools/metaclade2/metaclade2/metaclade2 ".$args;}
	else if ($form == 'clan'){
		$pfam = $parameters['Clan'].".txt";	
		$args = $args." -D ".$approot."/data/clans/".escapeshellarg($pfam);	
		$args = $args." -t ".escapeshellarg(4);
		$command="qsub -pe smp 3 -wd ".$approot."/jobs/".$job_id."/ -N $job_id -b y /home/blachon/Documents/Tools/metaclade2/metaclade2/metaclade2 ".$args;}
