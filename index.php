<?php include("./includes/header.php"); ?>
	...
	<ol type="1" class="ordonned_list">
		<li>It explores large datasets of a few thousands amino-acid sequences and extracts those sequences containing few targeted domains.</li>
		...
		<br/>
		MyCLADE annotates protein sequences with a library of more than 2.5 million probabilistic models for the whole Pfam32 database (17,929 domains). <span class="important">For this reason, keep in mind that a domain annotation of a single protein sequence could take the same time as for 50-100 sequences.</span></p>
