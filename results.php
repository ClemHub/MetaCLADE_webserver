...
?>
	...
	echo "<br><a id = 'dl_link' href=".$dl_file." download=results.csv><i class='fa fa-download'></i>Download the CSV resulting file</a>";
		...
		<thead id='header'>
			<tr>
			<th class='table_header' style='width:25%'><span class='tooltip'><i class='far fa-question-circle'></i><span class='tooltiptext'>Click on the sequence ID to see the architecture.</span></span> Sequence ID</th>
			<th class='table_header' style='width:50%'>Domain Id</th>
			<th class='table_header' style='width:25%'><span class='tooltip'><i class='far fa-question-circle'></i><span class='tooltiptext'>After comparing every annotated Pfam domains E-value for each sequences.</span></span> Best e-value </th>
			</tr>
		</thead>
		<tfoot>
			<tr>
