	...
	<h2> Your job is running... </h2>
		...
		if($output){
			...
			if($end){
				...
				file_put_contents($approot."/jobs/".$job_id."/results.txt", "SeqID\tSeq start\tSeq stop\tSeq length\tDomain ID\tModel ID\tModel start\tModel stop\tModel size\tE-value\tBiscore\tAccuracy\tSpecies of the template used for the model\n");
